...
<div class="listcontainer">
    <div id="listcontainerhead">
        <div>
            ...
            <p>In dieser Liste finden Sie alle gespeicherten Code-Kombinationen. Um einen Code zu laden, klicken Sie diesen an.</p>
        </div>
        <div id="closelistcontainer"><i class="fas fa-times"></i></div>
    </div>
    <hr>
    <ul>
        <li>Test</li>
