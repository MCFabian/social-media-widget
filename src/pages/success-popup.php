...
<body>
    ...
    <div class="full-height flex">
        <div class="popup center-box">
            ...
            <hr>
            <?php echo"<p class='larger-text'>Der Code wurde erfolgreich gespeichert! Deine gespeicherte ID lautet:<br> <strong title='Code kopieren' id='creationcode' class='chip expandme'>$myc</strong></p> ";?>
